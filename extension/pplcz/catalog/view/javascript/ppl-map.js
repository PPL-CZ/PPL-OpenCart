function PplMap (onComplete, data) {
    ...
    if (window.PPLczPlugin)
    {
        url.searchParams.set("route", "extension/pplcz/shipping/pplcz.map")
    }
    else {
        url.searchParams.set("route", "extension/pplcz/shipping/map")
    }
    ...
    jQuery(pplMap).html('<div id="pplcz-parcelshop-map-overlay2">' +
        '<a id="pplcz-parcelshop-map-close" href="#" >ZavĹ™Ă­t</a>' +
