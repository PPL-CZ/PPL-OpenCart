...
class ShipmentModel extends \ArrayObject
{
     ...
     * @return float|null
     */
    public function getBatchId() : ?float
    {
        return $this->batchId;
    }
    /**
     * 
     *
     * @param float|null $batchId
     *
     * @return self
     */
    public function setBatchId(?float $batchId) : self
    {
     ...
     * @return float|null
     */
    public function getBatchOrder() : ?float
    {
     ...
     * 
     *
     * @param float|null $batchOrder
     *
     * @return self
     */
    public function setBatchOrder(?float $batchOrder) : self
    {
        $this->initialized['batchOrder'] = true;
