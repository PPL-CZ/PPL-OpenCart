...
class CartModelNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('taxId', $data) && \is_int($data['taxId'])) {
            $data['taxId'] = (double) $data['taxId'];
        }
        ...
        if (\array_key_exists('age15Required', $data) && $data['age15Required'] !== null) {
            $object->setAge15Required($data['age15Required']);
            unset($data['age15Required']);
        }
        elseif (\array_key_exists('age15Required', $data) && $data['age15Required'] === null) {
            $object->setAge15Required(null);
        }
        if (\array_key_exists('age18Required', $data) && $data['age18Required'] !== null) {
            $object->setAge18Required($data['age18Required']);
            unset($data['age18Required']);
        }
        elseif (\array_key_exists('age18Required', $data) && $data['age18Required'] === null) {
            $object->setAge18Required(null);
        }
    ...
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        if ($object->isInitialized('age15Required') && null !== $object->getAge15Required()) {
            $data['age15Required'] = $object->getAge15Required();
        }
        if ($object->isInitialized('age18Required') && null !== $object->getAge18Required()) {
            $data['age18Required'] = $object->getAge18Required();
        }
