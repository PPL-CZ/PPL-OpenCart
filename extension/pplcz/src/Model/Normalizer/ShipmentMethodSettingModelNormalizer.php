...
class ShipmentMethodSettingModelNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('guid', $data) && $data['guid'] !== null) {
            $object->setGuid($data['guid']);
            unset($data['guid']);
        }
        elseif (\array_key_exists('guid', $data) && $data['guid'] === null) {
            $object->setGuid(null);
        }
        ...
        if (\array_key_exists('countries', $data) && $data['countries'] !== null) {
            $values_3 = array();
            foreach ($data['countries'] as $value_3) {
                $values_3[] = $value_3;
            }
            $object->setCountries($values_3);
    ...
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        if ($object->isInitialized('countries') && null !== $object->getCountries()) {
            $values_3 = array();
            foreach ($object->getCountries() as $value_3) {
                $values_3[] = $value_3;
            }
            $data['countries'] = $values_3;
        }
