...
class ShipmentModelNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('batchId', $data) && \is_int($data['batchId'])) {
            $data['batchId'] = (double) $data['batchId'];
        }
        if (\array_key_exists('batchOrder', $data) && \is_int($data['batchOrder'])) {
            $data['batchOrder'] = (double) $data['batchOrder'];
        }
        ...
        if (\array_key_exists('batchOrder', $data) && $data['batchOrder'] !== null) {
            $object->setBatchOrder($data['batchOrder']);
            unset($data['batchOrder']);
        }
        elseif (\array_key_exists('batchOrder', $data) && $data['batchOrder'] === null) {
            $object->setBatchOrder(null);
        }
    ...
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        if ($object->isInitialized('batchOrder') && null !== $object->getBatchOrder()) {
            $data['batchOrder'] = $object->getBatchOrder();
        }
