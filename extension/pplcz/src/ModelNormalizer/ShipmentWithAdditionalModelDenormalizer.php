...
class ShipmentWithAdditionalModelDenormalizer implements DenormalizerInterface
{
    ...
    public function denormalize($data, string $type, ?string $format = null, array $context = [])
    {
        ...
        $validator->validate($shipmentModel, $errors);
        if ($errors->errors)
        {
            $errors = $normalizer->denormalize($errors, WpErrorModel::class . '[]');
    ...
    {
        if (($data instanceof ShipmentData || $data instanceof OrderProxy)
